      ...
      <section classname="flex justify-center items-center min-h-screen">
        <div classname="flex flex-col w-[60%] justify-center items-center lg:px-48 md:px-44 sm:px-28 px-20 flex-wrap">
          ...
          <div classname="flex justify-start flex-col gap-4">
            <edinix repo="{{" owner:="" "itsme-subid",="" repo:="" "hacknitr",="" }}="" classname="App-link" id="test1" filepath="{&quot;client/src/components/home.jsx&quot;}" style="{{" color:="" "grey"="">Contribute to open source projects with ease, without worrying about git and github.test</edinix>
