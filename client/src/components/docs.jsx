	...
	return (
		<>
			...
			<div className='flex h-screen overflow-hidden'>
				<div className='flex-grow mx-10 py-4 w-3/4'>
					...
					<p className='text-justify'>
						...
						molestias consectetur suscipit impedit necessitatibus atque
						doloribus totam ullam temporibus, ea cupiditate praesentium aperiam
						obcaecati ab. Amet dolores aut magnam modi temporibus obcaecati.
					</p>
