    ...
    <div className="flex h-screen overflow-hidden">
      <div className="flex-grow mx-10 py-4 w-2/3">
        ...
        <ul className="list-disc ml-20">
          ...
          <li>
            Seamless Integration with GitHub: GitEase seamlessly integrates with
            GitHub, allowing users to manage their repositories without ever
            leaving the platform. Whether it&apos;s creating branches, merging
            changes, or managing issues, GitEase streamlines the entire process.
          </li>
          <li>
            Version Control for Everyone: By abstracting away the complexities
            of Git and GitHub, GitEase democratizes version control, making it
            accessible to a broader audience. Non-coders, designers, and project
            managers can now collaborate more efficiently without being hindered
            by technical barriers.
          </li>
          <li>
            Customization and Extensibility: GitEase is highly customizable and
            extensible, allowing users to tailor their version control workflow
            to suit their specific needs. Whether it&apos;s customizing commit
            templates or integrating with third-party tools, GitEase provides
